...
// Fallback models in priority order - using only stable, generally available models
const MODELS = [
  'gemini-1.5-flash-002',  // Stable, fast, cost-effective
  'gemini-1.5-flash-001',  // Previous stable version
